...
void RunInFiber() {
	INFO("RunInFiber begin");
	cppsvr::Fiber::YieldToHold();
	INFO("RunInFiber end");
	cppsvr::Fiber::YieldToHold();
}
...
void TestFiber() {
	INFO("main begin -1");
	{
		...
		INFO("main begin");
		cppsvr::Fiber::ptr oFiber(new cppsvr::Fiber(RunInFiber));
		oFiber->SwapIn(); // 这里开始调用这个协程（但是运行一半被上面第一个 YieldToHold 给挂起了）
		INFO("main after SwapIn"); // 回到主协程
		oFiber->SwapIn(); // 继续调用，不过又被第二个 YieldToHold 挂起
		INFO("main after end"); // 回到主协程
		oFiber->SwapIn(); // 继续调用，这次就顺利走完回调函数了。
...
int main(int argc, char **argv) {
	...
	for (int i = 0; i < 3; ++i) {
		vecThreads.push_back(cppsvr::Thread::ptr(
			new cppsvr::Thread(&TestFiber, "name_" + std::to_string(i))));
	}
...
2024-06-26 10:54:17 (121744,name_0) [INFO] XXX/cppsvr/test/testfiber.cpp:9 RunInFiber begin
2024-06-26 10:54:17 (121744,name_0) [INFO] XXX/cppsvr/test/testfiber.cpp:23 main after swapIn
2024-06-26 10:54:17 (121744,name_0) [INFO] XXX/cppsvr/test/testfiber.cpp:11 RunInFiber end
...
2024-06-26 10:54:17 (121745,name_1) [INFO] XXX/cppsvr/test/testfiber.cpp:9 RunInFiber begin
2024-06-26 10:54:17 (121745,name_1) [INFO] XXX/cppsvr/test/testfiber.cpp:23 main after swapIn
2024-06-26 10:54:17 (121745,name_1) [INFO] XXX/cppsvr/test/testfiber.cpp:11 RunInFiber end
...
2024-06-26 10:54:17 (121746,name_2) [INFO] XXX/cppsvr/test/testfiber.cpp:9 RunInFiber begin
2024-06-26 10:54:17 (121746,name_2) [INFO] XXX/cppsvr/test/testfiber.cpp:23 main after swapIn
2024-06-26 10:54:17 (121746,name_2) [INFO] XXX/cppsvr/test/testfiber.cpp:11 RunInFiber end
