...
MainReactor::MainReactor(uint32_t iCoroutineNum) : CoroutinePool(iCoroutineNum), m_iListenFd(-1) {
...
void MainReactor::InitCoroutines() {
	...
	pAcceptCoroutine = new Coroutine(std::bind(&MainReactor::AcceptCoroutine, this));
